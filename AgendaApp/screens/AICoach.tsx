...
const CoachScreen = () => {
  ...
  if (userDataString) {
    try {
      ...
      console.log("Gebruiker geladen uit AsyncStorage:", userData); // Debug hier
      setUserEmail(userData.email); // ✅ Fix: geen `.user`
    } catch (e) {
      console.error("Fout bij parsen van user data:", e);
      setUserEmail(null);
    }
  }
};
